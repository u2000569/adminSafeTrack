...
class SPaginatedDataTable extends StatelessWidget {
  const SPaginatedDataTable({
    ...
    this.onPageChanged, 
    this.dataRowHeight = SSizes.xl * 2, 
        ...
        child: PaginatedDataTable2(
          ...
          headingRowDecoration: const BoxDecoration(
            borderRadius: BorderRadius.only(
              ...
              topRight: Radius.circular(SSizes.borderRadiusMd),
            ),
          ),
          empty: const SAnimationLoaderWidget(animation: SImages.tableIllustration, text: 'Nothing Found', height: 200, width: 200),
          ...
          sortArrowBuilder: (bool ascending, bool sorted) {
            if (sorted) {
              return Icon(ascending ? Iconsax.arrow_up_3 : Iconsax.arrow_down, size: SSizes.iconSm);
            } else {
              return const Icon(Iconsax.arrow_3, size: SSizes.iconSm);
            }
          },
        ),
      ),
